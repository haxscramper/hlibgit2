...
proc git_object_lookup_bypath*(`out`: `ptr` git_object, treeish: `ptr` git_object, path: cstring, `type`: git_object_t): cint {.git2Proc, importc.}

proc git_object_id*(obj: `ptr` git_object): `ptr` git_oid {.git2Proc, importc.}

proc git_object_short_id*(`out`: `ptr` git_buf, obj: `ptr` git_object): cint {.git2Proc, importc.}

proc git_object_type*(obj: `ptr` git_object): git_object_t {.git2Proc, importc.}

proc git_object_owner*(obj: `ptr` git_object): `ptr` git_repository {.git2Proc, importc.}

proc git_object_free*(`object`: `ptr` git_object): void {.git2Proc, importc.}

proc git_object_type2string*(`type`: git_object_t): cstring {.git2Proc, importc.}
