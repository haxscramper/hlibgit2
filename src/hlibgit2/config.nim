...
proc git_config_get_multivar_foreach*(cfg: `ptr` git_config, name: cstring, regexp: cstring, callback: git_config_foreach_cb, payload: pointer): cint {.git2Proc, importc.}
...
proc git_config_foreach*(cfg: `ptr` git_config, callback: git_config_foreach_cb, payload: pointer): cint {.git2Proc, importc.}
...
proc git_config_foreach_match*(cfg: `ptr` git_config, regexp: cstring, callback: git_config_foreach_cb, payload: pointer): cint {.git2Proc, importc.}
...
proc git_config_backend_foreach_match*(backend: `ptr` git_config_backend, regexp: cstring, callback: git_config_foreach_cb, payload: pointer): cint {.git2Proc, importc.}
