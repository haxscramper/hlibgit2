...
proc git_odb_foreach*(db: `ptr` git_odb, cb: git_odb_foreach_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_odb_write*(`out`: `ptr` git_oid, odb: `ptr` git_odb, data: pointer, len: csize_t, `type`: git_object_t): cint {.git2Proc, importc.}
...
proc git_odb_write_pack*(`out`: `ptr` git_odb_writepack, db: `ptr` git_odb, progress_cb: git_indexer_progress_cb, progress_payload: pointer): cint {.git2Proc, importc.}

proc git_odb_write_multi_pack_index*(db: `ptr` git_odb): cint {.git2Proc, importc.}

proc git_odb_hash*(`out`: `ptr` git_oid, data: pointer, len: csize_t, `type`: git_object_t): cint {.git2Proc, importc.}
...
proc git_odb_object_data*(`object`: `ptr` git_odb_object): pointer {.git2Proc, importc.}
