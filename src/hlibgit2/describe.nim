...
type
  git_describe_options* {.header: "<describe.h>", importc, bycopy.} = object
    version                     *: cuint
  ...
  git_describe_format_options* {.header: "<describe.h>", importc, bycopy.} = object
    version                *: cuint
    abbreviated_size       *: cuint
    always_use_long_format *: cint
    dirty_suffix           *: cstring

  git_describe_result* {.header: "<describe.h>", importc, incompleteStruct.} = object
...
proc git_describe_options_init*(opts: ptr git_describe_options, version: cuint): cint {.importc: "git_describe_options_init", header: "<describe.h>".}

proc git_describe_format_options_init*(opts: ptr git_describe_format_options, version: cuint): cint {.importc: "git_describe_format_options_init", header: "<describe.h>".}

proc git_describe_commit*(
    result: ptr ptr git_describe_result,
    committish: ptr git_object,
    opts: ptr git_describe_options,
): cint {.importc: "git_describe_commit", header: "<describe.h>".}

proc git_describe_workdir*(
    `out`: ptr ptr git_describe_result,
    repo: ptr git_repository,
    opts: ptr git_describe_options,
): cint {.importc: "git_describe_workdir", header: "<describe.h>".}

proc git_describe_format*(
    `out`: ptr git_buf,
    result: ptr git_describe_result,
    opts: ptr git_describe_format_options,
): cint {.importc: "git_describe_format", header: "<describe.h>".}

proc git_describe_result_free*(result: ptr git_describe_result): void {.importc: "git_describe_result_free", header: "<describe.h>".}