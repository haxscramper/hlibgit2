...
proc git_oid_fromstr*(arg_out: ptr git_oid; str: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_fromstrp*(arg_out: ptr git_oid; str: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_fromstrn*(arg_out: ptr git_oid; str: cstring; length: size_t): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_fromraw*(arg_out: ptr git_oid; raw: ptr uchar): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_fmt*(arg_out: cstring; id: ptr git_oid): cint {.dynlib: libgitDl,
    importc.}
proc git_oid_nfmt*(arg_out: cstring; n: size_t; id: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_pathfmt*(arg_out: cstring; id: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_oid_tostr_s*(oid: ptr git_oid): cstring {.dynlib: libgitDl, importc.}
proc git_oid_tostr*(arg_out: cstring; n: size_t; id: ptr git_oid): cstring {.
    dynlib: libgitDl, importc.}
proc git_oid_cpy*(arg_out: ptr git_oid; src: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
