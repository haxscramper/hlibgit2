...
proc git_reference_foreach*(repo: `ptr` git_repository, callback: git_reference_foreach_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_reference_foreach_name*(repo: `ptr` git_repository, callback: git_reference_foreach_name_cb, payload: pointer): cint {.git2Proc, importc.}
...
proc git_reference_foreach_glob*(repo: `ptr` git_repository, glob: cstring, callback: git_reference_foreach_name_cb, payload: pointer): cint {.git2Proc, importc.}
