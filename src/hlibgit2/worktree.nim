...
proc git_worktree_list*(arg_out: ptr git_strarray; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_worktree_lookup*(arg_out: ptr ptr git_worktree;
                          repo: ptr git_repository; name: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_worktree_open_from_repository*(arg_out: ptr ptr git_worktree;
...
proc git_worktree_add_options_init*(opts: ptr git_worktree_add_options;
    ...
    importc.}
proc git_worktree_add*(arg_out: ptr ptr git_worktree; repo: ptr git_repository;
