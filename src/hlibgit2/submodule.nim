...
type
  git_submodule_update_options* {.header: "<submodule.h>", importc, bycopy.} = object
    version       *: cuint
...
proc git_submodule_update_options_init*(opts: ptr git_submodule_update_options, version: cuint): cint {.importc: "git_submodule_update_options_init", header: "<submodule.h>".}

proc git_submodule_update*(
    submodule: ptr git_submodule,
    init: cint,
    options: ptr git_submodule_update_options,
): cint {.importc: "git_submodule_update", header: "<submodule.h>".}

proc git_submodule_lookup*(
    `out`: ptr ptr git_submodule,
    repo: ptr git_repository,
    name: cstring,
): cint {.importc: "git_submodule_lookup", header: "<submodule.h>".}

proc git_submodule_dup*(`out`: ptr ptr git_submodule, source: ptr git_submodule): cint {.importc: "git_submodule_dup", header: "<submodule.h>".}

proc git_submodule_free*(submodule: ptr git_submodule): void {.importc: "git_submodule_free", header: "<submodule.h>".}

proc git_submodule_foreach*(
    repo: ptr git_repository,
    callback: git_submodule_cb,
    payload: pointer,
): cint {.importc: "git_submodule_foreach", header: "<submodule.h>".}
...
proc git_submodule_add_setup*(
    ...
    path: cstring,
    use_gitlink: cint,
): cint {.importc: "git_submodule_add_setup", header: "<submodule.h>".}

proc git_submodule_clone*(
    `out`: ptr ptr git_repository,
    submodule: ptr git_submodule,
    opts: ptr git_submodule_update_options,
): cint {.importc: "git_submodule_clone", header: "<submodule.h>".}

proc git_submodule_add_finalize*(submodule: ptr git_submodule): cint {.importc: "git_submodule_add_finalize", header: "<submodule.h>".}

proc git_submodule_add_to_index*(submodule: ptr git_submodule, write_index: cint): cint {.importc: "git_submodule_add_to_index", header: "<submodule.h>".}

proc git_submodule_owner*(submodule: ptr git_submodule): ptr git_repository {.importc: "git_submodule_owner", header: "<submodule.h>".}

proc git_submodule_name*(submodule: ptr git_submodule): cstring {.importc: "git_submodule_name", header: "<submodule.h>".}

proc git_submodule_path*(submodule: ptr git_submodule): cstring {.importc: "git_submodule_path", header: "<submodule.h>".}

proc git_submodule_url*(submodule: ptr git_submodule): cstring {.importc: "git_submodule_url", header: "<submodule.h>".}

proc git_submodule_resolve_url*(
    `out`: ptr git_buf,
    repo: ptr git_repository,
    url: cstring,
): cint {.importc: "git_submodule_resolve_url", header: "<submodule.h>".}

proc git_submodule_branch*(submodule: ptr git_submodule): cstring {.importc: "git_submodule_branch", header: "<submodule.h>".}

proc git_submodule_set_branch*(
    repo: ptr git_repository,
    name: cstring,
    branch: cstring,
): cint {.importc: "git_submodule_set_branch", header: "<submodule.h>".}

proc git_submodule_set_url*(
    repo: ptr git_repository,
    name: cstring,
    url: cstring,
): cint {.importc: "git_submodule_set_url", header: "<submodule.h>".}

proc git_submodule_index_id*(submodule: ptr git_submodule): ptr git_oid {.importc: "git_submodule_index_id", header: "<submodule.h>".}

proc git_submodule_head_id*(submodule: ptr git_submodule): ptr git_oid {.importc: "git_submodule_head_id", header: "<submodule.h>".}

proc git_submodule_wd_id*(submodule: ptr git_submodule): ptr git_oid {.importc: "git_submodule_wd_id", header: "<submodule.h>".}

proc git_submodule_ignore*(submodule: ptr git_submodule): git_submodule_ignore_t {.importc: "git_submodule_ignore", header: "<submodule.h>".}

proc git_submodule_set_ignore*(
    repo: ptr git_repository,
    name: cstring,
    ignore: git_submodule_ignore_t,
): cint {.importc: "git_submodule_set_ignore", header: "<submodule.h>".}

proc git_submodule_update_strategy*(submodule: ptr git_submodule): git_submodule_update_t {.importc: "git_submodule_update_strategy", header: "<submodule.h>".}

proc git_submodule_set_update*(
    repo: ptr git_repository,
    name: cstring,
    update: git_submodule_update_t,
): cint {.importc: "git_submodule_set_update", header: "<submodule.h>".}

proc git_submodule_fetch_recurse_submodules*(submodule: ptr git_submodule): git_submodule_recurse_t {.importc: "git_submodule_fetch_recurse_submodules", header: "<submodule.h>".}

proc git_submodule_set_fetch_recurse_submodules*(
    repo: ptr git_repository,
    name: cstring,
    fetch_recurse_submodules: git_submodule_recurse_t,
): cint {.importc: "git_submodule_set_fetch_recurse_submodules", header: "<submodule.h>".}

proc git_submodule_init*(submodule: ptr git_submodule, overwrite: cint): cint {.importc: "git_submodule_init", header: "<submodule.h>".}

proc git_submodule_repo_init*(
    `out`: ptr ptr git_repository,
    sm: ptr git_submodule,
    use_gitlink: cint,
): cint {.importc: "git_submodule_repo_init", header: "<submodule.h>".}

proc git_submodule_sync*(submodule: ptr git_submodule): cint {.importc: "git_submodule_sync", header: "<submodule.h>".}

proc git_submodule_open*(repo: ptr ptr git_repository, submodule: ptr git_submodule): cint {.importc: "git_submodule_open", header: "<submodule.h>".}

proc git_submodule_reload*(submodule: ptr git_submodule, force: cint): cint {.importc: "git_submodule_reload", header: "<submodule.h>".}
...
proc git_submodule_status*(
    ...
    name: cstring,
    ignore: git_submodule_ignore_t,
): cint {.importc: "git_submodule_status", header: "<submodule.h>".}

proc git_submodule_location*(location_status: ptr cuint, submodule: ptr git_submodule): cint {.importc: "git_submodule_location", header: "<submodule.h>".}