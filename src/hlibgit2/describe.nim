...
proc git_describe_commit*(result: `ptr` git_describe_result, committish: `ptr` git_object, opts: `ptr` git_describe_options): cint {.git2Proc, importc: "git_describe_commit".}

proc git_describe_workdir*(`out`: `ptr` git_describe_result, repo: `ptr` git_repository, opts: `ptr` git_describe_options): cint {.git2Proc, importc: "git_describe_workdir".}
