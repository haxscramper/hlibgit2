...
proc git_config_add_backend*(
    ...
    force: cint,
): cint {.git2Proc, importc: "git_config_add_backend".}
...
proc git_config_open_default*(`out`: ptr ptr git_config): cint {.git2Proc, importc: "git_config_open_default".}

proc git_config_new*(`out`: ptr ptr git_config): cint {.git2Proc, importc: "git_config_new".}
...
proc git_config_add_file_ondisk*(
    ...
    repo: ptr git_repository,
    force: cint,
): cint {.git2Proc, importc: "git_config_add_file_ondisk".}

proc git_config_open_ondisk*(`out`: ptr ptr git_config, path: cstring): cint {.git2Proc, importc: "git_config_open_ondisk".}

proc git_config_open_level*(
    `out`: ptr ptr git_config,
    parent: ptr git_config,
    level: git_config_level_t,
): cint {.git2Proc, importc: "git_config_open_level".}

proc git_config_open_global*(`out`: ptr ptr git_config, config: ptr git_config): cint {.git2Proc, importc: "git_config_open_global".}

proc git_config_snapshot*(`out`: ptr ptr git_config, config: ptr git_config): cint {.git2Proc, importc: "git_config_snapshot".}
...
proc git_config_get_entry*(
    ...
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_entry".}

proc git_config_get_int32*(
    `out`: ptr int32,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_int32".}

proc git_config_get_int64*(
    `out`: ptr int64,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_int64".}

proc git_config_get_bool*(
    `out`: ptr cint,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_bool".}

proc git_config_get_path*(
    `out`: ptr git_buf,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_path".}

proc git_config_get_string*(
    `out`: cstringArray,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_string".}

proc git_config_get_string_buf*(
    `out`: ptr git_buf,
    cfg: ptr git_config,
    name: cstring,
): cint {.git2Proc, importc: "git_config_get_string_buf".}
...
proc git_config_get_multivar_foreach*(
    ...
    payload: pointer,
): cint {.git2Proc, importc: "git_config_get_multivar_foreach".}
...
proc git_config_multivar_iterator_new*(
    ...
    name: cstring,
    regexp: cstring,
): cint {.git2Proc, importc: "git_config_multivar_iterator_new".}

proc git_config_next*(entry: ptr ptr git_config_entry, iter: ptr git_config_iterator): cint {.git2Proc, importc: "git_config_next".}
...
proc git_config_set_int32*(
    ...
    name: cstring,
    value: int32,
): cint {.git2Proc, importc: "git_config_set_int32".}

proc git_config_set_int64*(
    cfg: ptr git_config,
    name: cstring,
    value: int64,
): cint {.git2Proc, importc: "git_config_set_int64".}

proc git_config_set_bool*(
    cfg: ptr git_config,
    name: cstring,
    value: cint,
): cint {.git2Proc, importc: "git_config_set_bool".}

proc git_config_set_string*(
    cfg: ptr git_config,
    name: cstring,
    value: cstring,
): cint {.git2Proc, importc: "git_config_set_string".}
...
proc git_config_set_multivar*(
    ...
    regexp: cstring,
    value: cstring,
): cint {.git2Proc, importc: "git_config_set_multivar".}
...
proc git_config_delete_multivar*(
    ...
    name: cstring,
    regexp: cstring,
): cint {.git2Proc, importc: "git_config_delete_multivar".}

proc git_config_foreach*(
    cfg: ptr git_config,
    callback: git_config_foreach_cb,
    payload: pointer,
): cint {.git2Proc, importc: "git_config_foreach".}

proc git_config_iterator_new*(`out`: ptr ptr git_config_iterator, cfg: ptr git_config): cint {.git2Proc, importc: "git_config_iterator_new".}

proc git_config_iterator_glob_new*(
    `out`: ptr ptr git_config_iterator,
    cfg: ptr git_config,
    regexp: cstring,
): cint {.git2Proc, importc: "git_config_iterator_glob_new".}
...
proc git_config_foreach_match*(
    ...
    callback: git_config_foreach_cb,
    payload: pointer,
): cint {.git2Proc, importc: "git_config_foreach_match".}
...
proc git_config_get_mapped*(
    ...
    map_n: csize_t,
): cint {.git2Proc, importc: "git_config_get_mapped".}
...
proc git_config_lookup_map_value*(
    ...
    map_n: csize_t,
    value: cstring,
): cint {.git2Proc, importc: "git_config_lookup_map_value".}
...
proc git_config_backend_foreach_match*(
    ...
    callback: git_config_foreach_cb,
    payload: pointer,
): cint {.git2Proc, importc: "git_config_backend_foreach_match".}

proc git_config_lock*(tx: ptr ptr git_transaction, cfg: ptr git_config): cint {.git2Proc, importc: "git_config_lock".}