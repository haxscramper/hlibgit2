...
proc git_tag_lookup*(`out`: `ptr` git_tag, repo: `ptr` git_repository, id: `ptr` git_oid): cint {.git2Proc, importc: "git_tag_lookup".}

proc git_tag_lookup_prefix*(`out`: `ptr` git_tag, repo: `ptr` git_repository, id: `ptr` git_oid, len: csize_t): cint {.git2Proc, importc: "git_tag_lookup_prefix".}

proc git_tag_free*(tag: `ptr` git_tag): void {.git2Proc, importc: "git_tag_free".}

proc git_tag_id*(tag: `ptr` git_tag): `ptr` git_oid {.git2Proc, importc: "git_tag_id".}

proc git_tag_owner*(tag: `ptr` git_tag): `ptr` git_repository {.git2Proc, importc: "git_tag_owner".}

proc git_tag_target*(target_out: `ptr` git_object, tag: `ptr` git_tag): cint {.git2Proc, importc: "git_tag_target".}

proc git_tag_target_id*(tag: `ptr` git_tag): `ptr` git_oid {.git2Proc, importc: "git_tag_target_id".}

proc git_tag_target_type*(tag: `ptr` git_tag): git_object_t {.git2Proc, importc: "git_tag_target_type".}

proc git_tag_name*(tag: `ptr` git_tag): cstring {.git2Proc, importc: "git_tag_name".}

proc git_tag_tagger*(tag: `ptr` git_tag): `ptr` git_signature {.git2Proc, importc: "git_tag_tagger".}
...
proc git_tag_peel*(tag_target_out: `ptr` git_object, tag: `ptr` git_tag): cint {.git2Proc, importc: "git_tag_peel".}

proc git_tag_dup*(`out`: `ptr` git_tag, source: `ptr` git_tag): cint {.git2Proc, importc: "git_tag_dup".}

proc git_tag_name_is_valid*(valid: `ptr` cint, name: cstring): cint {.git2Proc, importc: "git_tag_name_is_valid".}