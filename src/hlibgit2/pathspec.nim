...
proc git_pathspec_new*(`out`: `ptr` git_pathspec, pathspec: `ptr` git_strarray): cint {.git2Proc, importc: "git_pathspec_new".}
...
proc git_pathspec_match_workdir*(`out`: `ptr` git_pathspec_match_list, repo: `ptr` git_repository, flags: uint32, ps: `ptr` git_pathspec): cint {.git2Proc, importc: "git_pathspec_match_workdir".}

proc git_pathspec_match_index*(`out`: `ptr` git_pathspec_match_list, index: `ptr` git_index, flags: uint32, ps: `ptr` git_pathspec): cint {.git2Proc, importc: "git_pathspec_match_index".}

proc git_pathspec_match_tree*(`out`: `ptr` git_pathspec_match_list, tree: `ptr` git_tree, flags: uint32, ps: `ptr` git_pathspec): cint {.git2Proc, importc: "git_pathspec_match_tree".}

proc git_pathspec_match_diff*(`out`: `ptr` git_pathspec_match_list, diff: `ptr` git_diff, flags: uint32, ps: `ptr` git_pathspec): cint {.git2Proc, importc: "git_pathspec_match_diff".}
