...
type
  git_commit_graph_writer_options* {.header: "<sys/commit_graph.h>", importc, bycopy.} = object
    version        *: cuint
...
proc git_commit_graph_open*(cgraph_out: ptr ptr git_commit_graph, objects_dir: cstring): cint {.importc: "git_commit_graph_open", header: "<sys/commit_graph.h>".}

proc git_commit_graph_free*(cgraph: ptr git_commit_graph): void {.importc: "git_commit_graph_free", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_new*(`out`: ptr ptr git_commit_graph_writer, objects_info_dir: cstring): cint {.importc: "git_commit_graph_writer_new", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_free*(w: ptr git_commit_graph_writer): void {.importc: "git_commit_graph_writer_free", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_add_index_file*(
    w: ptr git_commit_graph_writer,
    repo: ptr git_repository,
    idx_path: cstring,
): cint {.importc: "git_commit_graph_writer_add_index_file", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_add_revwalk*(w: ptr git_commit_graph_writer, walk: ptr git_revwalk): cint {.importc: "git_commit_graph_writer_add_revwalk", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_options_init*(opts: ptr git_commit_graph_writer_options, version: cuint): cint {.importc: "git_commit_graph_writer_options_init", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_commit*(w: ptr git_commit_graph_writer, opts: ptr git_commit_graph_writer_options): cint {.importc: "git_commit_graph_writer_commit", header: "<sys/commit_graph.h>".}

proc git_commit_graph_writer_dump*(
    buffer: ptr git_buf,
    w: ptr git_commit_graph_writer,
    opts: ptr git_commit_graph_writer_options,
): cint {.importc: "git_commit_graph_writer_dump", header: "<sys/commit_graph.h>".}