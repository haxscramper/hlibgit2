...
type
  ...
  git_credential_sign_cb* = proc(session: ptr LIBSSH2_SESSION1, sig: ptr ptr uint8, sig_len: ptr csize_t, data: ptr uint8, data_len1: csize_t, abstract: ptr pointer): cint{.cdecl.}
