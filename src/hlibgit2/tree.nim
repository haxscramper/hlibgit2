...
proc git_treebuilder_filter*(bld: `ptr` git_treebuilder, filter: git_treebuilder_filter_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_treebuilder_write*(id: `ptr` git_oid, bld: `ptr` git_treebuilder): cint {.git2Proc, importc.}

proc git_tree_walk*(tree: `ptr` git_tree, mode: git_treewalk_mode, callback: git_treewalk_cb, payload: pointer): cint {.git2Proc, importc.}
