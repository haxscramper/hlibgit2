...
type
  ...
  git_filter_check_fn* = proc (a0: ptr git_filter, a1: ptr ptr void, a2: ptr git_filter_source, a3: ptr ptr char): cint

  git_filter_apply_fn* = proc (a0: ptr git_filter, a1: ptr ptr void, a2: ptr git_buf, a3: ptr git_buf, a4: ptr git_filter_source): cint

  git_filter_stream_fn* = proc (a0: ptr ptr git_writestream, a1: ptr git_filter, a2: ptr ptr void, a3: ptr git_filter_source, a4: ptr git_writestream): cint
...
proc git_filter_list_new*(`out`: ptr ptr git_filter_list, repo: ptr git_repository, mode: git_filter_mode_t, options: uint32): cint {.git2Proc, importc: "git_filter_list_new".}

proc git_filter_list_push*(fl: ptr git_filter_list, filter: ptr git_filter, payload: pointer): cint {.git2Proc, importc: "git_filter_list_push".}
...
proc git_filter_register*(name: cstring, filter: ptr git_filter, priority: cint): cint {.git2Proc, importc: "git_filter_register".}
