...
proc git_branch_create*(
    ...
    force: cint,
): cint {.git2Proc, importc: "git_branch_create".}
...
proc git_branch_create_from_annotated*(
    ...
    force: cint,
): cint {.git2Proc, importc: "git_branch_create_from_annotated".}
...
): cint {.git2Proc, importc: "git_branch_iterator_new".}

proc git_branch_next*(
    `out`: ptr ptr git_reference,
    out_type: ptr git_branch_t,
    iter: ptr git_branch_iterator,
): cint {.git2Proc, importc: "git_branch_next".}
...
proc git_branch_move*(
    ...
    force: cint,
): cint {.git2Proc, importc: "git_branch_move".}
...
): cint {.git2Proc, importc: "git_branch_lookup".}

proc git_branch_name*(`out`: cstringArray, `ref`: ptr git_reference): cint {.git2Proc, importc: "git_branch_name".}
...
proc git_branch_upstream_name*(
    ...
    repo: ptr git_repository,
    refname: cstring,
): cint {.git2Proc, importc: "git_branch_upstream_name".}
...
proc git_branch_remote_name*(
    ...
    repo: ptr git_repository,
    refname: cstring,
): cint {.git2Proc, importc: "git_branch_remote_name".}

proc git_branch_upstream_remote*(
    buf: ptr git_buf,
    repo: ptr git_repository,
    refname: cstring,
): cint {.git2Proc, importc: "git_branch_upstream_remote".}

proc git_branch_upstream_merge*(
    buf: ptr git_buf,
    repo: ptr git_repository,
    refname: cstring,
): cint {.git2Proc, importc: "git_branch_upstream_merge".}
