...
proc git_mailmap_new*(arg_out: ptr ptr git_mailmap): cint {.dynlib: libgitDl,
    importc.}
...
proc git_mailmap_add_entry*(mm: ptr git_mailmap; real_name: cstring;
    ...
    importc.}
proc git_mailmap_from_buffer*(arg_out: ptr ptr git_mailmap; buf: cstring;
                              len: size_t): cint {.dynlib: libgitDl, importc.}
proc git_mailmap_from_repository*(arg_out: ptr ptr git_mailmap;
...
proc git_mailmap_resolve*(real_name: ptr cstring; real_email: ptr cstring;
    ...
    dynlib: libgitDl, importc.}
proc git_mailmap_resolve_signature*(arg_out: ptr ptr git_signature;
