...
proc git_commit_create_from_ids*(id: ptr git_oid, repo: ptr git_repository, update_ref: cstring, author: ptr git_signature, committer: ptr git_signature, message_encoding: cstring, message: cstring, tree: ptr git_oid, parent_count: csize_t, parents: ptr ptr git_oid): cint {.git2Proc, importc: "git_commit_create_from_ids".}