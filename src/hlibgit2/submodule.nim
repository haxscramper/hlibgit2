...
type
  ...
  git_submodule_cb = proc (a0: ptr git_submodule, a1: cstring, a2: ptr void): cint
...
proc git_submodule_foreach*(repo: ptr git_repository, callback: git_submodule_cb, payload: ptr void): cint {.git2Proc, importc.}
