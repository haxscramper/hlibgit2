...
proc git_blob_create_fromstream*(`out`: `ptr` git_writestream, repo: `ptr` git_repository, hintpath: cstring): cint {.git2Proc, importc: "git_blob_create_fromstream".}
...
proc git_cred_userpass_plaintext_new*(`out`: `ptr` git_credential, username: cstring, password: cstring): cint {.git2Proc, importc: "git_cred_userpass_plaintext_new".}

proc git_cred_default_new*(`out`: `ptr` git_credential): cint {.git2Proc, importc: "git_cred_default_new".}

proc git_cred_username_new*(`out`: `ptr` git_credential, username: cstring): cint {.git2Proc, importc: "git_cred_username_new".}

proc git_cred_ssh_key_new*(`out`: `ptr` git_credential, username: cstring, publickey: cstring, privatekey: cstring, passphrase: cstring): cint {.git2Proc, importc: "git_cred_ssh_key_new".}

proc git_cred_ssh_key_memory_new*(`out`: `ptr` git_credential, username: cstring, publickey: cstring, privatekey: cstring, passphrase: cstring): cint {.git2Proc, importc: "git_cred_ssh_key_memory_new".}

proc git_cred_ssh_interactive_new*(`out`: `ptr` git_credential, username: cstring, prompt_callback: git_credential_ssh_interactive_cb, payload: pointer): cint {.git2Proc, importc: "git_cred_ssh_interactive_new".}

proc git_cred_ssh_key_from_agent*(`out`: `ptr` git_credential, username: cstring): cint {.git2Proc, importc: "git_cred_ssh_key_from_agent".}

proc git_cred_ssh_custom_new*(`out`: `ptr` git_credential, username: cstring, publickey: cstring, publickey_len: csize_t, sign_callback: git_credential_sign_cb, payload: pointer): cint {.git2Proc, importc: "git_cred_ssh_custom_new".}

proc git_cred_userpass*(`out`: `ptr` git_credential, url: cstring, user_from_url: cstring, allowed_types: cuint, payload: pointer): cint {.git2Proc, importc: "git_cred_userpass".}
