...
proc git_pathspec_match_list_diff_entry*(m: ptr git_pathspec_match_list, pos: csize_t): ptr git_diff_delta {.importc: "git_pathspec_match_list_diff_entry".}

proc git_pathspec_match_list_failed_entrycount*(m: ptr git_pathspec_match_list): csize_t {.importc: "git_pathspec_match_list_failed_entrycount".}

proc git_pathspec_match_list_failed_entry*(m: ptr git_pathspec_match_list, pos: csize_t): cstring {.importc: "git_pathspec_match_list_failed_entry".}
...
proc git_pathspec_free*(ps: ptr git_pathspec): void {.importc: "git_pathspec_free".}

proc git_pathspec_matches_path*(
    ps: ptr git_pathspec,
    flags: uint32,
    path: cstring,
): cint {.importc: "git_pathspec_matches_path".}
...
proc git_pathspec_match_workdir*(
    ...
    flags: uint32,
    ps: ptr git_pathspec,
): cint {.importc: "git_pathspec_match_workdir".}
...
proc git_pathspec_match_index*(
    ...
    flags: uint32,
    ps: ptr git_pathspec,
): cint {.importc: "git_pathspec_match_index".}
...
proc git_pathspec_match_tree*(
    ...
    flags: uint32,
    ps: ptr git_pathspec,
): cint {.importc: "git_pathspec_match_tree".}
...
proc git_pathspec_match_diff*(
    ...
    flags: uint32,
    ps: ptr git_pathspec,
): cint {.importc: "git_pathspec_match_diff".}

proc git_pathspec_match_list_free*(m: ptr git_pathspec_match_list): void {.importc: "git_pathspec_match_list_free".}

proc git_pathspec_match_list_entrycount*(m: ptr git_pathspec_match_list): csize_t {.importc: "git_pathspec_match_list_entrycount".}

proc git_pathspec_match_list_entry*(m: ptr git_pathspec_match_list, pos: csize_t): cstring {.importc: "git_pathspec_match_list_entry".}