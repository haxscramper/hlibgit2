...
proc git_note_iterator_new*(`out`: ptr ptr git_note_iterator, repo: ptr git_repository, notes_ref: cstring): cint {.git2Proc, importc: "git_note_iterator_new".}

proc git_note_commit_iterator_new*(`out`: ptr ptr git_note_iterator, notes_commit: ptr git_commit): cint {.git2Proc, importc: "git_note_commit_iterator_new".}
...
proc git_note_read*(`out`: ptr ptr git_note, repo: ptr git_repository, notes_ref: cstring, oid: ptr git_oid): cint {.git2Proc, importc: "git_note_read".}

proc git_note_commit_read*(`out`: ptr ptr git_note, repo: ptr git_repository, notes_commit: ptr git_commit, oid: ptr git_oid): cint {.git2Proc, importc: "git_note_commit_read".}
