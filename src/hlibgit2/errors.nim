...
proc git_error_last*(a0: void): ptr git_error {.dynlib: libgitDl,
    importc: "git_error_last".}
proc git_error_clear*(a0: void): void {.dynlib: libgitDl,
                                        importc: "git_error_clear".}
proc git_error_set_str*(error_class: cint; string: cstring): cint {.
    dynlib: libgitDl, importc: "git_error_set_str".}
proc git_error_set_oom*(a0: void): void {.dynlib: libgitDl,
    importc: "git_error_set_oom".}