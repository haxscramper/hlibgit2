...
proc git_config_open_level*(`out`: ptr ptr git_config, parent: ptr git_config, level: git_config_level_t): cint {.git2Proc, importc: "git_config_open_level".}
...
proc git_config_get_entry*(`out`: ptr ptr git_config_entry, cfg: ptr git_config, name: cstring): cint {.git2Proc, importc: "git_config_get_entry".}
...
proc git_config_get_string*(`out`: ptr ptr char, cfg: ptr git_config, name: cstring): cint {.git2Proc, importc: "git_config_get_string".}
...
proc git_config_multivar_iterator_new*(`out`: ptr ptr git_config_iterator, cfg: ptr git_config, name: cstring, regexp: cstring): cint {.git2Proc, importc: "git_config_multivar_iterator_new".}
...
proc git_config_iterator_glob_new*(`out`: ptr ptr git_config_iterator, cfg: ptr git_config, regexp: cstring): cint {.git2Proc, importc: "git_config_iterator_glob_new".}
