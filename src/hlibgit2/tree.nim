...
proc git_tree_lookup*(arg_out: ptr ptr git_tree; repo: ptr git_repository;
                      id: ptr git_oid): cint {.dynlib: libgitDl, importc.}
proc git_tree_lookup_prefix*(arg_out: ptr ptr git_tree;
...
proc git_tree_entry_byid*(tree: ptr git_tree; id: ptr git_oid): ptr git_tree_entry {.
    dynlib: libgitDl, importc.}
proc git_tree_entry_bypath*(arg_out: ptr ptr git_tree_entry; root: ptr git_tree;
...
proc git_tree_entry_to_object*(object_out: ptr ptr git_object;
    ...
    dynlib: libgitDl, importc.}
proc git_treebuilder_new*(arg_out: ptr ptr git_treebuilder;
...
proc git_treebuilder_get*(bld: ptr git_treebuilder; filename: cstring): ptr git_tree_entry {.
    dynlib: libgitDl, importc.}
proc git_treebuilder_insert*(arg_out: ptr ptr git_tree_entry;
...
proc git_tree_walk*(tree: ptr git_tree; mode: git_treewalk_mode;
    ...
    dynlib: libgitDl, importc.}
proc git_tree_dup*(arg_out: ptr ptr git_tree; source: ptr git_tree): cint {.
    dynlib: libgitDl, importc.}
proc git_tree_create_updated*(arg_out: ptr git_oid; repo: ptr git_repository;
