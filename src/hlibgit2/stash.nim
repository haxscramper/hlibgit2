...
type
  ...
  git_stash_apply_progress_cb* = proc(progress: c_git_stash_apply_progress_t, payload: pointer): cint{.cdecl.}
   
  git_stash_apply_progress_cbNim* = proc(progress: c_git_stash_apply_progress_t): cint
