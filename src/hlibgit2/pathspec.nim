...
proc git_pathspec_new*(arg_out: ptr ptr git_pathspec; pathspec: ptr git_strarray): cint {.
...
proc git_pathspec_match_workdir*(arg_out: ptr ptr git_pathspec_match_list;
                                 repo: ptr git_repository; flags: uint32;
                                 ps: ptr git_pathspec): cint {.dynlib: libgitDl,
    importc.}
proc git_pathspec_match_index*(arg_out: ptr ptr git_pathspec_match_list;
                               index: ptr git_index; flags: uint32;
                               ps: ptr git_pathspec): cint {.dynlib: libgitDl,
    importc.}
proc git_pathspec_match_tree*(arg_out: ptr ptr git_pathspec_match_list;
                              tree: ptr git_tree; flags: uint32;
                              ps: ptr git_pathspec): cint {.dynlib: libgitDl,
    importc.}
proc git_pathspec_match_diff*(arg_out: ptr ptr git_pathspec_match_list;
