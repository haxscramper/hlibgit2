...
proc git_repository_ident*(name: cstring, email: cstring, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_ident".}

proc git_repository_set_ident*(repo: `ptr` git_repository, name: cstring, email: cstring): cint {.git2Proc, importc: "git_repository_set_ident".}
...
proc git_repository_open*(`out`: `ptr` git_repository, path: cstring): cint {.git2Proc, importc: "git_repository_open".}

proc git_repository_open_from_worktree*(`out`: `ptr` git_repository, wt: `ptr` git_worktree): cint {.git2Proc, importc: "git_repository_open_from_worktree".}

proc git_repository_wrap_odb*(`out`: `ptr` git_repository, odb: `ptr` git_odb): cint {.git2Proc, importc: "git_repository_wrap_odb".}

proc git_repository_discover*(`out`: `ptr` git_buf, start_path: cstring, across_fs: cint, ceiling_dirs: cstring): cint {.git2Proc, importc: "git_repository_discover".}

proc git_repository_open_ext*(`out`: `ptr` git_repository, path: cstring, flags: cuint, ceiling_dirs: cstring): cint {.git2Proc, importc: "git_repository_open_ext".}

proc git_repository_open_bare*(`out`: `ptr` git_repository, bare_path: cstring): cint {.git2Proc, importc: "git_repository_open_bare".}

proc git_repository_free*(repo: `ptr` git_repository): void {.git2Proc, importc: "git_repository_free".}

proc git_repository_init*(`out`: `ptr` git_repository, path: cstring, is_bare: cuint): cint {.git2Proc, importc: "git_repository_init".}
...
proc git_repository_init_ext*(`out`: `ptr` git_repository, repo_path: cstring, opts: `ptr` git_repository_init_options): cint {.git2Proc, importc: "git_repository_init_ext".}

proc git_repository_head*(`out`: `ptr` git_reference, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_head".}

proc git_repository_head_for_worktree*(`out`: `ptr` git_reference, repo: `ptr` git_repository, name: cstring): cint {.git2Proc, importc: "git_repository_head_for_worktree".}
...
proc git_repository_item_path*(`out`: `ptr` git_buf, repo: `ptr` git_repository, item: git_repository_item_t): cint {.git2Proc, importc: "git_repository_item_path".}
...
proc git_repository_set_workdir*(repo: `ptr` git_repository, workdir: cstring, update_gitlink: cint): cint {.git2Proc, importc: "git_repository_set_workdir".}
...
proc git_repository_config*(`out`: `ptr` git_config, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_config".}

proc git_repository_config_snapshot*(`out`: `ptr` git_config, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_config_snapshot".}

proc git_repository_odb*(`out`: `ptr` git_odb, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_odb".}

proc git_repository_refdb*(`out`: `ptr` git_refdb, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_refdb".}

proc git_repository_index*(`out`: `ptr` git_index, repo: `ptr` git_repository): cint {.git2Proc, importc: "git_repository_index".}
...
proc git_repository_fetchhead_foreach*(repo: `ptr` git_repository, callback: git_repository_fetchhead_foreach_cb, payload: pointer): cint {.git2Proc, importc: "git_repository_fetchhead_foreach".}

proc git_repository_mergehead_foreach*(repo: `ptr` git_repository, callback: git_repository_mergehead_foreach_cb, payload: pointer): cint {.git2Proc, importc: "git_repository_mergehead_foreach".}

proc git_repository_hashfile*(`out`: `ptr` git_oid, repo: `ptr` git_repository, path: cstring, `type`: git_object_t, as_path: cstring): cint {.git2Proc, importc: "git_repository_hashfile".}
