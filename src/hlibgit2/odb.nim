...
proc git_odb_new*(arg_out: ptr ptr git_odb): cint {.dynlib: libgit2Dl, importc.}
...
proc git_odb_free*(db: ptr git_odb): void {.dynlib: libgit2Dl, importc.}
...
proc git_odb_refresh*(db: ptr git_odb): cint {.dynlib: libgit2Dl, importc.}
