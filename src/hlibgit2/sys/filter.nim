...
proc git_filter_list_new*(`out`: `ptr` git_filter_list, repo: `ptr` git_repository, mode: git_filter_mode_t, options: uint32): cint {.git2Proc, importc: "git_filter_list_new".}
