...
proc git_index_add_from_buffer*(index: `ptr` git_index, entry: `ptr` git_index_entry, buffer: pointer, len: csize_t): cint {.git2Proc, importc.}

proc git_index_remove_bypath*(index: `ptr` git_index, path: cstring): cint {.git2Proc, importc.}

proc git_index_add_all*(index: `ptr` git_index, pathspec: `ptr` git_strarray, flags: cuint, callback: git_index_matched_path_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_index_remove_all*(index: `ptr` git_index, pathspec: `ptr` git_strarray, callback: git_index_matched_path_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_index_update_all*(index: `ptr` git_index, pathspec: `ptr` git_strarray, callback: git_index_matched_path_cb, payload: pointer): cint {.git2Proc, importc.}
