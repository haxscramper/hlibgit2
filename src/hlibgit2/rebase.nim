...
proc git_rebase_options_init*(opts: ptr git_rebase_options; version: cuint): cint {.
    dynlib: libgitDl, importc: "git_rebase_options_init".}
...
proc git_rebase_commit*(id: ptr git_oid; rebase: ptr git_rebase;
    ...
    dynlib: libgitDl, importc: "git_rebase_commit".}
proc git_rebase_abort*(rebase: ptr git_rebase): cint {.dynlib: libgitDl,
    importc: "git_rebase_abort".}
proc git_rebase_finish*(rebase: ptr git_rebase; signature: ptr git_signature): cint {.
    dynlib: libgitDl, importc: "git_rebase_finish".}
proc git_rebase_free*(rebase: ptr git_rebase): void {.dynlib: libgitDl,
    importc: "git_rebase_free".}