...
): cint {.git2Proc, importc: "git_annotated_commit_from_ref".}
...
proc git_annotated_commit_from_fetchhead*(
    ...
    remote_url: cstring,
    id: ptr git_oid,
): cint {.git2Proc, importc: "git_annotated_commit_from_fetchhead".}

proc git_annotated_commit_lookup*(
    `out`: ptr ptr git_annotated_commit,
    repo: ptr git_repository,
    id: ptr git_oid,
): cint {.git2Proc, importc: "git_annotated_commit_lookup".}

proc git_annotated_commit_from_revspec*(
    `out`: ptr ptr git_annotated_commit,
    repo: ptr git_repository,
    revspec: cstring,
): cint {.git2Proc, importc: "git_annotated_commit_from_revspec".}
