...
proc git_note_iterator_new*(
    ...
    notes_ref: cstring,
): cint {.git2Proc, importc: "git_note_iterator_new".}
...
): cint {.git2Proc, importc: "git_note_next".}
...
proc git_note_read*(
    ...
    notes_ref: cstring,
    oid: ptr git_oid,
): cint {.git2Proc, importc: "git_note_read".}
...
proc git_note_commit_read*(
    ...
    oid: ptr git_oid,
): cint {.git2Proc, importc: "git_note_commit_read".}
...
proc git_note_create*(
    ...
    note: cstring,
    force: cint,
): cint {.git2Proc, importc: "git_note_create".}
...
): cint {.git2Proc, importc: "git_note_commit_create".}
...
proc git_note_remove*(
    ...
    committer: ptr git_signature,
    oid: ptr git_oid,
): cint {.git2Proc, importc: "git_note_remove".}
...
proc git_note_commit_remove*(
    ...
    committer: ptr git_signature,
    oid: ptr git_oid,
): cint {.git2Proc, importc: "git_note_commit_remove".}
...
proc git_note_foreach*(
    ...
    payload: pointer,
): cint {.git2Proc, importc: "git_note_foreach".}