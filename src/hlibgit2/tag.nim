...
proc git_tag_lookup*(arg_out: ptr ptr git_tag; repo: ptr git_repository;
                     id: ptr git_oid): cint {.dynlib: libgitDl, importc.}
proc git_tag_lookup_prefix*(arg_out: ptr ptr git_tag; repo: ptr git_repository;
...
proc git_tag_peel*(tag_target_out: ptr ptr git_object; tag: ptr git_tag): cint {.
    dynlib: libgitDl, importc.}
proc git_tag_dup*(arg_out: ptr ptr git_tag; source: ptr git_tag): cint {.
    dynlib: libgitDl, importc.}