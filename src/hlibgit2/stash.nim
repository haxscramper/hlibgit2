...
type
  ...
  git_stash_apply_progress_cb = proc (a0: git_stash_apply_progress_t, a1: ptr void): cint
  ...
  c_git_stash_apply_progress_t {.size: sizeof(cint).} = enum
    c_GIT_STASH_APPLY_PROGRESS_NONE               = 0 shl 0
    c_GIT_STASH_APPLY_PROGRESS_LOADING_STASH      = 1 shl 0
    c_GIT_STASH_APPLY_PROGRESS_ANALYZE_INDEX      = 1 shl 1
    c_GIT_STASH_APPLY_PROGRESS_ANALYZE_MODIFIED   = 3
    c_GIT_STASH_APPLY_PROGRESS_ANALYZE_UNTRACKED  = 1 shl 2
  ...
  git_stash_cb = proc (a0: csize_t, a1: cstring, a2: ptr git_oid, a3: ptr void): cint
