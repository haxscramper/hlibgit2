...
proc git_oid_tostr_s*(oid: ptr git_oid): cstring {.dynlib: libgit2Dl, importc.}
...
proc git_oid_is_zero*(id: ptr git_oid): cint {.dynlib: libgit2Dl, importc.}


proc git_oid_shorten_new*(
    min_length: csize_t
  ): ptr git_oid_shorten {.dynlib: libgit2Dl, importc.}
