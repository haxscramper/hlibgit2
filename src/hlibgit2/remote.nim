...
proc git_remote_create*(arg_out: ptr ptr git_remote; repo: ptr git_repository;
...
proc git_remote_create_options_init*(opts: ptr git_remote_create_options;
    ...
    importc.}
proc git_remote_create_with_opts*(arg_out: ptr ptr git_remote; url: cstring;
                                  opts: ptr git_remote_create_options): cint {.
    dynlib: libgitDl, importc.}
proc git_remote_create_with_fetchspec*(arg_out: ptr ptr git_remote;
                                       repo: ptr git_repository; name: cstring;
                                       url: cstring; fetch: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_remote_create_anonymous*(arg_out: ptr ptr git_remote;
                                  repo: ptr git_repository; url: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_remote_create_detached*(arg_out: ptr ptr git_remote; url: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_remote_lookup*(arg_out: ptr ptr git_remote; repo: ptr git_repository;
...
proc git_remote_connect*(remote: ptr git_remote; direction: git_direction;
    ...
    dynlib: libgitDl, importc.}
proc git_remote_ls*(arg_out: ptr ptr ptr git_remote_head; size: ptr size_t;
...
proc git_remote_list*(arg_out: ptr git_strarray; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
...
proc git_remote_delete*(repo: ptr git_repository; name: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_remote_default_branch*(arg_out: ptr git_buf; remote: ptr git_remote): cint {.
    dynlib: libgitDl, importc.}