...
proc to_c_git_config_level_t*(arg: git_config_level_t): c_git_config_level_t = 
  case arg:
    of GIT_CONFIG_HIGHEST_LEVEL:
      c_GIT_CONFIG_HIGHEST_LEVEL
    of GIT_CONFIG_LEVEL_PROGRAMDATA:
      c_GIT_CONFIG_LEVEL_PROGRAMDATA
    of GIT_CONFIG_LEVEL_SYSTEM:
      c_GIT_CONFIG_LEVEL_SYSTEM
    of GIT_CONFIG_LEVEL_XDG:
      c_GIT_CONFIG_LEVEL_XDG
    of GIT_CONFIG_LEVEL_GLOBAL:
      c_GIT_CONFIG_LEVEL_GLOBAL
    of GIT_CONFIG_LEVEL_LOCAL:
      c_GIT_CONFIG_LEVEL_LOCAL
    of GIT_CONFIG_LEVEL_APP:
      c_GIT_CONFIG_LEVEL_APP
...
converter to_git_config_level_t*(
  ...
  case arg:
    of c_GIT_CONFIG_HIGHEST_LEVEL:
      GIT_CONFIG_HIGHEST_LEVEL
    of c_GIT_CONFIG_LEVEL_PROGRAMDATA:
      GIT_CONFIG_LEVEL_PROGRAMDATA
    of c_GIT_CONFIG_LEVEL_SYSTEM:
      GIT_CONFIG_LEVEL_SYSTEM
    of c_GIT_CONFIG_LEVEL_XDG:
      GIT_CONFIG_LEVEL_XDG
    of c_GIT_CONFIG_LEVEL_GLOBAL:
      GIT_CONFIG_LEVEL_GLOBAL
    of c_GIT_CONFIG_LEVEL_LOCAL:
      GIT_CONFIG_LEVEL_LOCAL
    of c_GIT_CONFIG_LEVEL_APP:
      GIT_CONFIG_LEVEL_APP
...
func `+`*(arg: c_git_config_level_t, offset: int): c_git_config_level_t = 
  c_git_config_level_t(ord(arg) + offset)
...
proc to_c_git_configmap_t*(arg: git_configmap_t): c_git_configmap_t = 
  case arg:
    of GIT_CONFIGMAP_FALSE:
      c_GIT_CONFIGMAP_FALSE
    of GIT_CONFIGMAP_TRUE:
      c_GIT_CONFIGMAP_TRUE
    of GIT_CONFIGMAP_INT32:
      c_GIT_CONFIGMAP_INT32
    of GIT_CONFIGMAP_STRING:
      c_GIT_CONFIGMAP_STRING
 

converter to_git_configmap_t*(arg: c_git_configmap_t): git_configmap_t = 
  case arg:
    of c_GIT_CONFIGMAP_FALSE:
      GIT_CONFIGMAP_FALSE
    of c_GIT_CONFIGMAP_TRUE:
      GIT_CONFIGMAP_TRUE
    of c_GIT_CONFIGMAP_INT32:
      GIT_CONFIGMAP_INT32
    of c_GIT_CONFIGMAP_STRING:
      GIT_CONFIGMAP_STRING
...
func `+`*(arg: c_git_configmap_t, offset: int): c_git_configmap_t = 
  c_git_configmap_t(ord(arg) + offset)
