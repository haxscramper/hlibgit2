...
proc git_email_create_from_diff*(`out`: `ptr` cint, diff: `ptr` cint, patch_idx: csize_t, patch_count: csize_t, commit_id: `ptr` const int, summary: cstring, body: cstring, author: `ptr` const int, opts: `ptr` git_email_create_options): cint {.git2Proc, importc: "git_email_create_from_diff".}

proc git_email_create_from_commit*(`out`: `ptr` cint, commit: `ptr` cint, opts: `ptr` git_email_create_options): cint {.git2Proc, importc: "git_email_create_from_commit".}