...
proc git_note_iterator_new*(arg_out: ptr ptr git_note_iterator;
                            repo: ptr git_repository; notes_ref: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_note_commit_iterator_new*(arg_out: ptr ptr git_note_iterator;
...
proc git_note_read*(arg_out: ptr ptr git_note; repo: ptr git_repository;
                    notes_ref: cstring; oid: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_note_commit_read*(arg_out: ptr ptr git_note; repo: ptr git_repository;
...
proc git_note_create*(arg_out: ptr git_oid; repo: ptr git_repository;
...
proc git_note_default_ref*(arg_out: ptr git_buf; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
