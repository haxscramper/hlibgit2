...
proc git_mailmap_new*(out: ptr ptr git_mailmap): cint {.dynlib: libgitDl,
    importc: "git_mailmap_new".}
proc git_mailmap_free*(mm: ptr git_mailmap): void {.dynlib: libgitDl,
    importc: "git_mailmap_free".}
