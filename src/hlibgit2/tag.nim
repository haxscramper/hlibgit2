...
proc git_tag_target*(target_out: ptr ptr git_object, tag: ptr git_tag): cint {.git2Proc, importc: "git_tag_target".}
...
proc git_tag_dup*(`out`: ptr ptr git_tag, source: ptr git_tag): cint {.git2Proc, importc: "git_tag_dup".}
