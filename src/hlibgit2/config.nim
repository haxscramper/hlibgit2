...
proc git_config_entry_free*(a0: ptr git_config_entry): void {.dynlib: libgitDl,
    importc.}
proc git_config_find_global*(arg_out: ptr git_buf): cint {.dynlib: libgitDl,
    importc.}
proc git_config_find_xdg*(arg_out: ptr git_buf): cint {.dynlib: libgitDl,
    importc.}
proc git_config_find_system*(arg_out: ptr git_buf): cint {.dynlib: libgitDl,
    importc.}
proc git_config_find_programdata*(arg_out: ptr git_buf): cint {.
    dynlib: libgitDl, importc.}
proc git_config_open_default*(arg_out: ptr ptr git_config): cint {.
    dynlib: libgitDl, importc.}
proc git_config_new*(arg_out: ptr ptr git_config): cint {.dynlib: libgitDl,
    importc.}
proc git_config_add_file_ondisk*(cfg: ptr git_config; path: cstring;
    ...
    dynlib: libgitDl, importc.}
proc git_config_open_ondisk*(arg_out: ptr ptr git_config; path: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_open_level*(arg_out: ptr ptr git_config; parent: ptr git_config;
                            level: git_config_level_t): cint {.dynlib: libgitDl,
    importc.}
proc git_config_open_global*(arg_out: ptr ptr git_config; config: ptr git_config): cint {.
    dynlib: libgitDl, importc.}
proc git_config_snapshot*(arg_out: ptr ptr git_config; config: ptr git_config): cint {.
    dynlib: libgitDl, importc.}
proc git_config_free*(cfg: ptr git_config): void {.dynlib: libgitDl, importc.}
proc git_config_get_entry*(arg_out: ptr ptr git_config_entry;
                           cfg: ptr git_config; name: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_get_int32*(arg_out: ptr int32; cfg: ptr git_config;
                           name: cstring): cint {.dynlib: libgitDl, importc.}
proc git_config_get_int64*(arg_out: ptr int64; cfg: ptr git_config;
                           name: cstring): cint {.dynlib: libgitDl, importc.}
proc git_config_get_bool*(arg_out: ptr cint; cfg: ptr git_config; name: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_get_path*(arg_out: ptr git_buf; cfg: ptr git_config;
                          name: cstring): cint {.dynlib: libgitDl, importc.}
proc git_config_get_string*(arg_out: ptr cstring; cfg: ptr git_config;
                            name: cstring): cint {.dynlib: libgitDl, importc.}
proc git_config_get_string_buf*(arg_out: ptr git_buf; cfg: ptr git_config;
                                name: cstring): cint {.dynlib: libgitDl, importc.}
proc git_config_get_multivar_foreach*(cfg: ptr git_config; name: cstring;
    ...
    dynlib: libgitDl, importc.}
proc git_config_multivar_iterator_new*(arg_out: ptr ptr git_config_iterator;
...
proc git_config_iterator_new*(arg_out: ptr ptr git_config_iterator;
                              cfg: ptr git_config): cint {.dynlib: libgitDl,
    importc.}
proc git_config_iterator_glob_new*(arg_out: ptr ptr git_config_iterator;
...
proc git_config_foreach_match*(cfg: ptr git_config; regexp: cstring;
    ...
    dynlib: libgitDl, importc.}
proc git_config_get_mapped*(arg_out: ptr cint; cfg: ptr git_config;
                            name: cstring; maps: ptr git_configmap;
                            map_n: size_t): cint {.dynlib: libgitDl, importc.}
proc git_config_lookup_map_value*(arg_out: ptr cint; maps: ptr git_configmap;
                                  map_n: size_t; value: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_parse_bool*(arg_out: ptr cint; value: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_parse_int32*(arg_out: ptr int32; value: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_parse_int64*(arg_out: ptr int64; value: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_config_parse_path*(arg_out: ptr git_buf; value: cstring): cint {.
    dynlib: libgitDl, importc.}
