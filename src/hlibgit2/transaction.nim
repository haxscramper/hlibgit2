...
proc git_transaction_set_target*(
    ...
    msg: cstring,
): cint {.git2Proc, importc: "git_transaction_set_target".}
...
proc git_transaction_set_symbolic_target*(
    ...
    sig: ptr git_signature,
    msg: cstring,
): cint {.git2Proc, importc: "git_transaction_set_symbolic_target".}

proc git_transaction_set_reflog*(
    tx: ptr git_transaction,
    refname: cstring,
    reflog: ptr git_reflog,
): cint {.git2Proc, importc: "git_transaction_set_reflog".}
