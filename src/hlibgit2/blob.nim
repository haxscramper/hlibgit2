...
proc git_blob_filter_options_init*(opts: ptr git_blob_filter_options;
    ...
    importc.}
proc git_blob_filter*(arg_out: ptr git_buf; blob: ptr git_blob;
                      as_path: cstring; opts: ptr git_blob_filter_options): cint {.
    dynlib: libgitDl, importc.}
...
proc git_blob_create_from_stream*(arg_out: ptr ptr git_writestream;
                                  repo: ptr git_repository; hintpath: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_blob_create_from_stream_commit*(arg_out: ptr git_oid;
...
proc git_blob_dup*(arg_out: ptr ptr git_blob; source: ptr git_blob): cint {.
    dynlib: libgitDl, importc.}