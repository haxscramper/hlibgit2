...
type
  ...
  git_odb_object* {.importc, bycopy.} = object


  git_midx_writer* {.importc, bycopy.} = object


  git_refdb* {.importc, bycopy.} = object


  git_commit_graph* {.importc, bycopy.} = object
  ...
  git_object* {.importc, bycopy.} = object


  git_revwalk* {.importc, bycopy.} = object


  git_tag* {.importc, bycopy.} = object


  git_blob* {.importc, bycopy.} = object


  git_commit* {.importc, bycopy.} = object


  git_tree_entry* {.importc, bycopy.} = object


  git_tree* {.importc, bycopy.} = object


  git_treebuilder* {.importc, bycopy.} = object


  git_index* {.importc, bycopy.} = object


  git_index_iterator* {.importc, bycopy.} = object


  git_index_conflict_iterator* {.importc, bycopy.} = object


  git_config* {.importc, bycopy.} = object


  git_reflog_entry* {.importc, bycopy.} = object


  git_reflog* {.importc, bycopy.} = object


  git_note* {.importc, bycopy.} = object


  git_packbuilder* {.importc, bycopy.} = object
  ...
  git_annotated_commit* {.importc, bycopy.} = object


  git_status_list* {.importc, bycopy.} = object


  git_rebase* {.importc, bycopy.} = object


  git_refspec* {.importc, bycopy.} = object


  git_remote* {.importc, bycopy.} = object
  ...
  git_mailmap* {.importc, bycopy.} = object


  c_git_reference_t {.size: sizeof(cint).} = enum
    c_GIT_REFERENCE_INVALID  = 0 shl 0
    c_GIT_REFERENCE_DIRECT   = 1 shl 0
    c_GIT_REFERENCE_SYMBOLIC = 1 shl 1
  ...
  c_git_filemode_t {.size: sizeof(cint).} = enum
    c_GIT_FILEMODE_UNREADABLE      = 0 shl 0
  ...
  c_git_submodule_update_t {.size: sizeof(cint).} = enum
    ...
    c_GIT_SUBMODULE_UPDATE_DEFAULT  = 0 shl 0
  ...
  c_git_submodule_ignore_t {.size: sizeof(cint).} = enum
    ...
    c_GIT_SUBMODULE_IGNORE_NONE        = 1 shl 0
    c_GIT_SUBMODULE_IGNORE_UNTRACKED   = 1 shl 1
    c_GIT_SUBMODULE_IGNORE_DIRTY       = 3
    c_GIT_SUBMODULE_IGNORE_ALL         = 1 shl 2
