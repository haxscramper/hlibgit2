...
proc git_signature_new*(`out`: ptr ptr git_signature, name: cstring, email: cstring, time: git_time_t, offset: cint): cint {.git2Proc, importc: "git_signature_new".}

proc git_signature_now*(`out`: ptr ptr git_signature, name: cstring, email: cstring): cint {.git2Proc, importc: "git_signature_now".}
