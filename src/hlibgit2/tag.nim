type
  ...
  git_tag_foreach_cb = proc (a0: cstring, a1: ptr git_oid, a2: ptr void): cint
...
proc `git_tag_foreach`*(repo: ptr git_repository, callback: git_tag_foreach_cb, payload: ptr void): cint {.git2Proc, importc.}
