...
proc git_merge_analysis_for_ref*(analysis_out: ptr git_merge_analysis_t;
    ...
    dynlib: libgitDl, importc.}
proc git_merge_base*(arg_out: ptr git_oid; repo: ptr git_repository;
                     one: ptr git_oid; two: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_bases*(arg_out: ptr git_oidarray; repo: ptr git_repository;
                      one: ptr git_oid; two: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_base_many*(arg_out: ptr git_oid; repo: ptr git_repository;
                          length: size_t;
                          input_array: ptr UncheckedArray[git_oid]): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_bases_many*(arg_out: ptr git_oidarray; repo: ptr git_repository;
                           length: size_t;
                           input_array: ptr UncheckedArray[git_oid]): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_base_octopus*(arg_out: ptr git_oid; repo: ptr git_repository;
                             length: size_t;
                             input_array: ptr UncheckedArray[git_oid]): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_file*(arg_out: ptr git_merge_file_result;
    ...
    importc.}
proc git_merge_file_from_index*(arg_out: ptr git_merge_file_result;
                                repo: ptr git_repository;
...
proc git_merge_file_result_free*(result: ptr git_merge_file_result): void {.
    dynlib: libgitDl, importc.}
proc git_merge_trees*(arg_out: ptr ptr git_index; repo: ptr git_repository;
                      ancestor_tree: ptr git_tree; our_tree: ptr git_tree;
                      their_tree: ptr git_tree; opts: ptr git_merge_options): cint {.
    dynlib: libgitDl, importc.}
proc git_merge_commits*(arg_out: ptr ptr git_index; repo: ptr git_repository;
