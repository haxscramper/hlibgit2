...
proc git_patch_from_blob_and_buffer*(`out`: `ptr` git_patch, old_blob: `ptr` git_blob, old_as_path: cstring, buffer: pointer, buffer_len: csize_t, buffer_as_path: cstring, opts: `ptr` git_diff_options): cint {.git2Proc, importc.}

proc git_patch_from_buffers*(`out`: `ptr` git_patch, old_buffer: pointer, old_len: csize_t, old_as_path: cstring, new_buffer: pointer, new_len: csize_t, new_as_path: cstring, opts: `ptr` git_diff_options): cint {.git2Proc, importc.}
...
proc git_patch_print*(patch: `ptr` git_patch, print_cb: git_diff_line_cb, payload: pointer): cint {.git2Proc, importc.}
