...
proc git_blob_lookup*(blob: `ptr` git_blob, repo: `ptr` git_repository, id: `ptr` git_oid): cint {.git2Proc, importc: "git_blob_lookup".}

proc git_blob_lookup_prefix*(blob: `ptr` git_blob, repo: `ptr` git_repository, id: `ptr` git_oid, len: csize_t): cint {.git2Proc, importc: "git_blob_lookup_prefix".}
...
proc git_blob_create_from_stream*(`out`: `ptr` git_writestream, repo: `ptr` git_repository, hintpath: cstring): cint {.git2Proc, importc: "git_blob_create_from_stream".}
...
proc git_blob_dup*(`out`: `ptr` git_blob, source: `ptr` git_blob): cint {.git2Proc, importc: "git_blob_dup".}