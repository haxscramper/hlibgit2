...
proc git_annotated_commit_from_fetchhead*(arg_out: ptr ptr git_annotated_commit;
    repo: ptr git_repository; branch_name: cstring; remote_url: cstring;
    id: ptr git_oid): cint {.dynlib: libgitDl, importc.}
proc git_annotated_commit_lookup*(arg_out: ptr ptr git_annotated_commit;
                                  repo: ptr git_repository; id: ptr git_oid): cint {.
    dynlib: libgitDl, importc.}
proc git_annotated_commit_from_revspec*(arg_out: ptr ptr git_annotated_commit;
                                        repo: ptr git_repository;
