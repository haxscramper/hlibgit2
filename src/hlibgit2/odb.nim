...
proc git_odb_backend_pack*(`out`: `ptr` git_odb_backend, objects_dir: cstring): cint {.git2Proc, importc: "git_odb_backend_pack".}

proc git_odb_backend_one_pack*(`out`: `ptr` git_odb_backend, index_file: cstring): cint {.git2Proc, importc: "git_odb_backend_one_pack".}

proc git_odb_backend_loose*(`out`: `ptr` git_odb_backend, objects_dir: cstring, compression_level: cint, do_fsync: cint, dir_mode: cuint, file_mode: cuint): cint {.git2Proc, importc: "git_odb_backend_loose".}
...
proc git_odb_new*(`out`: `ptr` git_odb): cint {.git2Proc, importc: "git_odb_new".}

proc git_odb_open*(`out`: `ptr` git_odb, objects_dir: cstring): cint {.git2Proc, importc: "git_odb_open".}
...
proc git_odb_read*(`out`: `ptr` git_odb_object, db: `ptr` git_odb, id: `ptr` git_oid): cint {.git2Proc, importc: "git_odb_read".}

proc git_odb_read_prefix*(`out`: `ptr` git_odb_object, db: `ptr` git_odb, short_id: `ptr` git_oid, len: csize_t): cint {.git2Proc, importc: "git_odb_read_prefix".}
...
proc git_odb_open_wstream*(`out`: `ptr` git_odb_stream, db: `ptr` git_odb, size: git_object_size_t, `type`: git_object_t): cint {.git2Proc, importc: "git_odb_open_wstream".}
...
proc git_odb_open_rstream*(`out`: `ptr` git_odb_stream, len: `ptr` csize_t, `type`: `ptr` git_object_t, db: `ptr` git_odb, oid: `ptr` git_oid): cint {.git2Proc, importc: "git_odb_open_rstream".}

proc git_odb_write_pack*(`out`: `ptr` git_odb_writepack, db: `ptr` git_odb, progress_cb: git_indexer_progress_cb, progress_payload: pointer): cint {.git2Proc, importc: "git_odb_write_pack".}
...
proc git_odb_object_dup*(dest: `ptr` git_odb_object, source: `ptr` git_odb_object): cint {.git2Proc, importc: "git_odb_object_dup".}
...
proc git_odb_get_backend*(`out`: `ptr` git_odb_backend, odb: `ptr` git_odb, pos: csize_t): cint {.git2Proc, importc: "git_odb_get_backend".}
