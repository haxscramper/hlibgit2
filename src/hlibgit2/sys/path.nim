...
type
  c_git_path_gitfile {.size: sizeof(cint).} = enum
    c_GIT_PATH_GITFILE_GITIGNORE     = 0 shl 0
    c_GIT_PATH_GITFILE_GITMODULES    = 1 shl 0
    c_GIT_PATH_GITFILE_GITATTRIBUTES = 1 shl 1
  ...
  c_git_path_fs {.size: sizeof(cint).} = enum
    c_GIT_PATH_FS_GENERIC = 0 shl 0
    c_GIT_PATH_FS_NTFS    = 1 shl 0
    c_GIT_PATH_FS_HFS     = 1 shl 1
