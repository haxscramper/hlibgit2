...
proc git_repository_open*(arg_out: ptr ptr git_repository; path: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_open_from_worktree*(arg_out: ptr ptr git_repository;
                                        wt: ptr git_worktree): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_wrap_odb*(arg_out: ptr ptr git_repository; odb: ptr git_odb): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_discover*(arg_out: ptr git_buf; start_path: cstring;
                              across_fs: cint; ceiling_dirs: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_open_ext*(arg_out: ptr ptr git_repository; path: cstring;
                              flags: cuint; ceiling_dirs: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_open_bare*(arg_out: ptr ptr git_repository;
                               bare_path: cstring): cint {.dynlib: libgitDl,
    importc.}
proc git_repository_free*(repo: ptr git_repository): void {.dynlib: libgitDl,
    importc.}
proc git_repository_init*(arg_out: ptr ptr git_repository; path: cstring;
...
proc git_repository_init_options_init*(opts: ptr git_repository_init_options;
    ...
    importc.}
proc git_repository_init_ext*(arg_out: ptr ptr git_repository;
                              repo_path: cstring;
                              opts: ptr git_repository_init_options): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_head*(arg_out: ptr ptr git_reference;
                          repo: ptr git_repository): cint {.dynlib: libgitDl,
    importc.}
proc git_repository_head_for_worktree*(arg_out: ptr ptr git_reference;
...
proc git_repository_is_empty*(repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_item_path*(arg_out: ptr git_buf; repo: ptr git_repository;
...
proc git_repository_is_worktree*(repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_config*(arg_out: ptr ptr git_config;
                            repo: ptr git_repository): cint {.dynlib: libgitDl,
    importc.}
proc git_repository_config_snapshot*(arg_out: ptr ptr git_config;
                                     repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_odb*(arg_out: ptr ptr git_odb; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_refdb*(arg_out: ptr ptr git_refdb; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_index*(arg_out: ptr ptr git_index; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_message*(arg_out: ptr git_buf; repo: ptr git_repository): cint {.
    dynlib: libgitDl, importc.}
...
proc git_repository_mergehead_foreach*(repo: ptr git_repository; callback: git_repository_mergehead_foreach_cb;
                                       payload: pointer): cint {.
    dynlib: libgitDl, importc.}
proc git_repository_hashfile*(arg_out: ptr git_oid; repo: ptr git_repository;
                              path: cstring; arg_type: git_object_t;
