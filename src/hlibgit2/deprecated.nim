...
proc git_blob_create_frombuffer*(id: `ptr` git_oid, repo: `ptr` git_repository, buffer: pointer, len: csize_t): cint {.git2Proc, importc.}
...
proc git_buf_set*(buffer: `ptr` git_buf, data: pointer, datalen: csize_t): cint {.git2Proc, importc.}
...
proc git_index_add_frombuffer*(index: `ptr` git_index, entry: `ptr` git_index_entry, buffer: pointer, len: csize_t): cint {.git2Proc, importc.}
...
proc git_cred_ssh_interactive_new*(`out`: `ptr` git_credential, username: cstring, prompt_callback: git_credential_ssh_interactive_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_cred_ssh_key_from_agent*(`out`: `ptr` git_credential, username: cstring): cint {.git2Proc, importc.}

proc git_cred_ssh_custom_new*(`out`: `ptr` git_credential, username: cstring, publickey: cstring, publickey_len: csize_t, sign_callback: git_credential_sign_cb, payload: pointer): cint {.git2Proc, importc.}

proc git_cred_userpass*(`out`: `ptr` git_credential, url: cstring, user_from_url: cstring, allowed_types: cuint, payload: pointer): cint {.git2Proc, importc.}
