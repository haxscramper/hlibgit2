...
proc git_reflog_read*(
    ...
    name: cstring,
): cint {.git2Proc, importc: "git_reflog_read".}
...
proc git_reflog_append*(
    ...
    msg: cstring,
): cint {.git2Proc, importc: "git_reflog_append".}

proc git_reflog_rename*(
    repo: ptr git_repository,
    old_name: cstring,
    name: cstring,
): cint {.git2Proc, importc: "git_reflog_rename".}
...
): cint {.git2Proc, importc: "git_reflog_drop".}
