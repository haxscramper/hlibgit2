...
proc git_filter_list_load*(filters: ptr ptr git_filter_list, repo: ptr git_repository, blob: ptr git_blob, path: cstring, mode: git_filter_mode_t, flags: uint32): cint {.git2Proc, importc: "git_filter_list_load".}

proc git_filter_list_load_ext*(filters: ptr ptr git_filter_list, repo: ptr git_repository, blob: ptr git_blob, path: cstring, mode: git_filter_mode_t, opts: ptr git_filter_options): cint {.git2Proc, importc: "git_filter_list_load_ext".}
