...
proc git_repository_ident*(name: ptr ptr char, email: ptr ptr char, repo: ptr git_repository): cint {.git2Proc, importc: "git_repository_ident".}
...
proc git_repository_open_ext*(`out`: ptr ptr git_repository, path: cstring, flags: cuint, ceiling_dirs: cstring): cint {.git2Proc, importc: "git_repository_open_ext".}
...
proc git_repository_init*(`out`: ptr ptr git_repository, path: cstring, is_bare: cuint): cint {.git2Proc, importc: "git_repository_init".}
...
proc git_repository_init_ext*(`out`: ptr ptr git_repository, repo_path: cstring, opts: ptr git_repository_init_options): cint {.git2Proc, importc: "git_repository_init_ext".}

proc git_repository_head*(`out`: ptr ptr git_reference, repo: ptr git_repository): cint {.git2Proc, importc: "git_repository_head".}

proc git_repository_head_for_worktree*(`out`: ptr ptr git_reference, repo: ptr git_repository, name: cstring): cint {.git2Proc, importc: "git_repository_head_for_worktree".}
