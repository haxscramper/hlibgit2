...
proc git_blob_create_fromstream*(arg_out: ptr ptr git_writestream;
                                 repo: ptr git_repository; hintpath: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_blob_create_fromstream_commit*(arg_out: ptr git_oid;
...
proc git_blob_create_frombuffer*(id: ptr git_oid; repo: ptr git_repository;
    ...
    dynlib: libgitDl, importc.}
proc git_blob_filtered_content*(arg_out: ptr git_buf; blob: ptr git_blob;
...
proc giterr_set_str*(error_class: cint; arg_string: cstring): void {.
    dynlib: libgitDl, importc.}
...
proc git_index_add_frombuffer*(index: ptr git_index; entry: ptr git_index_entry;
                               buffer: pointer; len: size_t): cint {.
    dynlib: libgitDl, importc.}
proc git_object_size*(arg_type: git_object_t): size_t {.dynlib: libgitDl,
...
proc git_cred_get_username*(cred: ptr git_credential): cstring {.
    dynlib: libgitDl, importc.}
proc git_cred_userpass_plaintext_new*(arg_out: ptr ptr git_credential;
                                      username: cstring; password: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_cred_default_new*(arg_out: ptr ptr git_credential): cint {.
    dynlib: libgitDl, importc.}
proc git_cred_username_new*(arg_out: ptr ptr git_credential; username: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_cred_ssh_key_new*(arg_out: ptr ptr git_credential; username: cstring;
                           publickey: cstring; privatekey: cstring;
                           passphrase: cstring): cint {.dynlib: libgitDl,
    importc.}
proc git_cred_ssh_key_memory_new*(arg_out: ptr ptr git_credential;
                                  username: cstring; publickey: cstring;
                                  privatekey: cstring; passphrase: cstring): cint {.
    dynlib: libgitDl, importc.}
proc git_cred_ssh_interactive_new*(arg_out: ptr ptr git_credential;
                                   username: cstring; prompt_callback: git_credential_ssh_interactive_cb;
                                   payload: pointer): cint {.dynlib: libgitDl,
    importc.}
proc git_cred_ssh_key_from_agent*(arg_out: ptr ptr git_credential;
                                  username: cstring): cint {.dynlib: libgitDl,
    importc.}
proc git_cred_ssh_custom_new*(arg_out: ptr ptr git_credential;
                              username: cstring; publickey: cstring;
                              publickey_len: size_t;
                              sign_callback: git_credential_sign_cb;
                              payload: pointer): cint {.dynlib: libgitDl,
    importc.}
proc git_cred_userpass*(arg_out: ptr ptr git_credential; url: cstring;
